...
def halvemmat(asunnot: list, verrattava: Asunto):
    ...
    return [(asunto.kuvaus, ((verrattava.neliohinta*verrattava.nelioita) - (asunto.neliohinta*asunto.nelioita))) for asunto in asunnot if (asunto.neliohinta*asunto.nelioita) < (verrattava.neliohinta*verrattava.nelioita)]
